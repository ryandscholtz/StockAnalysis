  ...
  return (
    <div className="card">
      ...
      <div className="metric">
        ...
        <span className="metric-value" style={{ color: analysis.fairValue > 0 ? '#059669' : '#dc2626', fontSize: '28px' }}>
          {analysis.fairValue > 0 ? formatPrice(analysis.fairValue, analysis.currency) : 'Unable to calculate'}
        </span>
        {analysis.fairValue === 0 && (
          <div style={{ marginTop: '8px', fontSize: '12px', color: '#dc2626', fontStyle: 'italic' }}>
      ...
      <div className="metric">
        ...
        <span className="metric-value" style={{ color: analysis.marginOfSafety > 0 ? '#059669' : '#dc2626' }}>
      ...
      <div className="metric">
        ...
        <span className="metric-value" style={{ color: analysis.upsidePotential > 0 ? '#059669' : '#dc2626' }}>
